...
class UniformInfo {
    ...
    size: number;
    isArray: boolean;
    constructor(name: string, location: WebGLUniformLocation | null, type: number, size: number, isArray: boolean) {
        this.name = name;
...
class Shader {
    ...
    _semanticToAttribName: Record<string, string>;
    _attributes: Record<string, WebGLUniformLocation>;
    _uniforms: Record<string, UniformInfo>;
    constructor() {
        this.program = null;
        this._semanticToAttribName = {}; // {[semantic:string]:string}
        this._attributes = {}; // {[name:string]:number}
        this._uniforms = {}; // {[name:string]:UniformInfo}
    }
    ...
    setAttributesMap(attributesMap: { semantic: string; name: string }[]) {
